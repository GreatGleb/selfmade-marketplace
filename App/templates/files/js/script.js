jQuery(document).ready(function($) {
	...
	$('.so-groups-sticky *[data-target="popup"]:not(.sticky-mycart)').on('click', function() {
	...
	$('.so-groups-sticky *[data-target="popup-close"]:not(.sticky-mycart)').on('click', function() {
			...
			success: function(json) {
				...
				if (json['success']) {
					...
					setTimeout(function () {
						...
						$('#cart .cart-total-full').html(json['total']);
					}, 100);
